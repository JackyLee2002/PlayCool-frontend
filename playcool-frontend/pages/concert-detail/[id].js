                ...
                >
                    ...
                    >
                        <CardMedia
                            ...
                            alt="Concert"
                            height="140"
                            image={"https://www.coldplay.com/wp/wp-content/uploads/2024/10/FM.webp"}
                            title="Concert"
                            sx={{ width: 140 }}
                        />
                        <CardContent sx={{ textAlign: "center" }}>
                            ...
                            <Typography variant="body" color="textSecondary" component="p">
                                {concert.venue.city + ", " + concert.venue.location + ", " + concert.venue.name}
                            </Typography>
                            <Typography variant="body" color="textSecondary" component="p">
                    ...
                    >
                        <Box
                            ...
                            <Button sx={{ marginRight: 10, fontSize: '3rem' }} variant="text"
                            ...
                            <CardMedia
                                ...
                                image={"/img.png"}
                                title="Concert"
                                sx={{ width: 900, marginTop: 10, marginLeft: "auto", marginRight: "auto" }}
                            />
                            <Button sx={{ marginLeft: "auto", fontSize: '3rem' }} variant="text" onClick={() => {
                        ...
                        <Box display="flex" flexWrap="wrap" justifyContent="center" sx={{ marginTop: 10, marginBottom: 10}}>
                            {ticketData && ticketData.length > 0 && ticketData.map((area) => (
                                <Card
                                    ...
                                    sx={{
                                        ...
                                        borderRadius: '4px',
                                        marginLeft: 10,
                                        backgroundColor: selectedAreaId === area.areaId ? '#90EE90' : (area.availableSeatsCount === 0 ? 'lightgray' : 'white'),
                                        cursor: area.availableSeatsCount > 0 ? 'pointer' : 'not-allowed',
                                    }}
                                    onClick={() => {
                                ...
                                >
                                    <CardContent>
                                        ...
                                        <Typography variant="body" sx={{ color: '#666', marginLeft: 2}}>
                                            {area.areaName}
                                        </Typography>
                                        <Typography
                                            variant="body1"
                                            sx={{ color: area.availableSeatsCount < 100 ? 'red' : 'green' }}
                                        >
